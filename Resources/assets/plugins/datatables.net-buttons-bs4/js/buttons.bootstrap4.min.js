...
(function (c) {
    ...
    c.extend(!0, a.Buttons.defaults, {
        dom: {
            ...
            button: {className: "btn btn-light waves-effect waves-float waves-light"},
            collection: {
                tag: "div",
            ...
            splitDropdown: {
                tag: "button",
                text: "",
                className: "btn btn-light waves-effect waves-float waves-light dt-btn-split-drop dropdown-toggle dropdown-toggle-split",
                closeButton: !1,
                align: "split-left",
            ...
            splitDropdownButton: {
                tag: "button",
                className: "dt-btn-split-drop-button btn btn-light waves-effect waves-float waves-light", closeButton: !1
            }
