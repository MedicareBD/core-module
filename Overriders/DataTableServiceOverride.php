...
namespace Modules\Core\Overriders;
...
abstract class DataTableServiceOverride implements DataTableButtons
{
    /**
    ...
    public function pdf()
    {
        ...
        if ('mpdf' == config('datatables-buttons.pdf_generator', 'mpdf')) {
            return $this->mPdf();
        }
